...
public class HomeController {
    ...
    protected void initialize() {
        ...
        serviceColumn.setCellValueFactory(cellValue -> new SimpleObjectProperty<>(cellValue.getValue().getServices()));

        siteColumn = new TableColumn<>("Site");
        siteColumn.setCellValueFactory(cellValue -> new SimpleObjectProperty(cellValue.getValue().getSite()));
